      ...
      <p>
        ...
        <div class="ui equal width padded grid">
          <div class="row">
            ...
            <div class="black left aligned column">
              <input class="Right-Panel left aligned padded"
                type="text"
                value={this.state.givenText}
                size="100"
                maxlength="20"
                />
            </div>
        ...
        <hr margin-block-start="0em" margin-block-end="0em" />
